...
/**
 * Agent Identity Format: spiffe://cortex/{domain}/{agent-id}
 *
 * Examples:
 *   spiffe://cortex/masters/coordinator-master
 *   spiffe://cortex/masters/development-master
 *   spiffe://cortex/workers/worker-implementation-042
 *   spiffe://cortex/daemons/heartbeat-monitor
 */
...
class AgentIdentity {
  ...
  async createIdentitiesRegistry() {
    const registry = {
      ...
      identities: {
        ...
        'coordinator-master': {
          spiffe_id: 'spiffe://cortex/masters/coordinator-master',
          role: 'master',
        ...
        'development-master': {
          spiffe_id: 'spiffe://cortex/masters/development-master',
          role: 'master',
          trust_level: this.trustLevels.SYSTEM,
        ...
        'security-master': {
          spiffe_id: 'spiffe://cortex/masters/security-master',
          role: 'master',
          trust_level: this.trustLevels.SYSTEM,
        ...
        'inventory-master': {
          spiffe_id: 'spiffe://cortex/masters/inventory-master',
          role: 'master',
          trust_level: this.trustLevels.SYSTEM,
        ...
        'cicd-master': {
          spiffe_id: 'spiffe://cortex/masters/cicd-master',
          role: 'master',
          trust_level: this.trustLevels.SYSTEM,
  ...
  generateSpiffeId(domain, agentId) {
    return `spiffe://cortex/${domain}/${agentId}`;
  }
  ...
  async issueToken(agentId, role, capabilities, trustLevel, metadata = {}) {
    try {
      ...
      const token = jwt.sign(payload, signingKey, {
        algorithm: 'RS256',
        issuer: 'cortex-identity-system',
        audience: 'cortex-agents'
      });
