 ...
 * and data flows through the cortex system.
 */
...
const PROJECT_ROOT = process.env.CORTEX_HOME || path.join(__dirname, '../..');
  ...
  async logAudit(event) {
    const auditRecord = {
      ...
      context: {
        ...
        user_agent: event.context?.user_agent || 'cortex-system',
