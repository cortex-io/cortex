...
class AccessControl {
  constructor(options = {}) {
    this.rolesPath = options.rolesPath || '/Users/ryandahlberg/Projects/commit-relay/coordination/governance/roles.json';
    this.auditLogPath = options.auditLogPath || '/Users/ryandahlberg/Projects/commit-relay/coordination/governance/access-log.jsonl';
    this.catalogPath = options.catalogPath || '/Users/ryandahlberg/Projects/commit-relay/coordination/catalog';
