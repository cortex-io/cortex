...
class CatalogManager {
  constructor(catalogPath = '/Users/ryandahlberg/commit-relay/coordination/catalog') {
  ...
  async _discoverCoordinationAssets() {
    const assets = [];
    const coordinationPath = '/Users/ryandahlberg/commit-relay/coordination';
  ...
  async _discoverMasterAgents() {
    ...
    for (const masterName of masterNames) {
      ...
      const statePath = `/Users/ryandahlberg/commit-relay/coordination/masters/${masterName}/context/master-state.json`;
      try {
      ...
      const kbPath = `/Users/ryandahlberg/commit-relay/coordination/masters/${masterName}/knowledge-base`;
      try {
  ...
  async _discoverWorkerSpecs() {
    const assets = [];
    const workerSpecPath = '/Users/ryandahlberg/commit-relay/coordination/worker-specs';
  ...
  async _discoverAgentPrompts() {
    const assets = [];
    const promptPath = '/Users/ryandahlberg/commit-relay/.claude/agents';
