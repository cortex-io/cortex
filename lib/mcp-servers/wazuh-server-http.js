...
/**
 * Wazuh MCP Server - HTTP/SSE Transport
 *
 * Standalone containerized MCP server for Wazuh SIEM integration
...
class WazuhMCPServer {
  ...
  async startHTTPServer() {
    ...
    httpServer.listen(PORT, () => {
      console.log(`Wazuh MCP Server running on http://0.0.0.0:${PORT}`);
      console.log(`MCP endpoint: http://0.0.0.0:${PORT}/mcp`);
      console.log(`Health check: http://0.0.0.0:${PORT}/health`);
      console.log(`Wazuh API: ${WAZUH_API_URL}`);
    });
