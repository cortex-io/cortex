...
class VectorStore {
  constructor(embedder = null) {
    ...
    // Collection types - dimensions will be set from embedder
    this.defaultDimension = 1536;
    this.collections = {
      'code': { dimension: this.defaultDimension, description: 'Code snippets and implementations' },
      'documentation': { dimension: this.defaultDimension, description: 'Documentation and runbooks' },
      'decisions': { dimension: this.defaultDimension, description: 'AI decision history and reasoning' },
      'patterns': { dimension: this.defaultDimension, description: 'Failure patterns and solutions' },
      'tasks': { dimension: this.defaultDimension, description: 'Task descriptions and outcomes' }
    };
  }
  ...
  async initialize() {
    try {
      ...
      for (const key of Object.keys(this.collections)) {
        this.collections[key].dimension = dimension;
      }
