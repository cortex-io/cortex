...
```bash
echo '{"timestamp": "'$(date -u +%Y-%m-%dT%H:%M:%SZ)'", "status": "working", "progress": "Analyzing codebase structure", "worker_id": "worker-implementation-045"}' > /Users/ryandahlberg/Projects/cortex/agents/workers/worker-implementation-045/heartbeat.json
```
