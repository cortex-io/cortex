...
```bash
echo '{"timestamp": "'$(date -u +%Y-%m-%dT%H:%M:%SZ)'", "status": "working", "progress": "Analyzing codebase structure", "worker_id": "worker-scan-035"}' > /Users/ryandahlberg/Projects/cortex/agents/workers/worker-scan-035/heartbeat.json
```
