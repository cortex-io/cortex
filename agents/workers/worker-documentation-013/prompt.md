...
```bash
echo '{"timestamp": "'$(date -u +%Y-%m-%dT%H:%M:%SZ)'", "status": "working", "progress": "Analyzing codebase structure", "worker_id": "worker-documentation-013"}' > /Users/ryandahlberg/Projects/cortex/agents/workers/worker-documentation-013/heartbeat.json
```
