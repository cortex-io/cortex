...
```bash
echo '{"timestamp": "'$(date -u +%Y-%m-%dT%H:%M:%SZ)'", "status": "working", "progress": "Analyzing codebase structure", "worker_id": "worker-scan-007"}' > /Users/ryandahlberg/Projects/cortex/agents/workers/worker-scan-007/heartbeat.json
```
